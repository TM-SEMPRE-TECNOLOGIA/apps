      ...
      <header className="app-header">
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-xl)' }}>
          <nav style={{ display: 'flex', gap: 'var(--space-md)' }}>
            <Link href="/guia" className="btn btn-ghost" style={{ textDecoration: 'none' }}>📖 Guia</Link>
            <Link href="/changelog" className="btn btn-ghost" style={{ textDecoration: 'none' }}>🚀 Novidades</Link>
          </nav>
